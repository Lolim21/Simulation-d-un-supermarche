...
radio_male=Radiobutton(root,text="2 caisses",value="2",bg="#29FFFF",variable=value_radio,indicatoron=0,width=10).pack(padx=15,pady=5,anchor=W)
radio_female=Radiobutton(root,text="3 caisses",value="3",bg="#29FFFF",variable=value_radio,indicatoron=0,width=10).pack(padx=15,pady=5,anchor=W)
...
Button(root, text="Afficher les reultats", command=AfficherTable).pack(padx=15,pady=5,anchor=W)
...
Button(root, text="Plot", command=AfficherPlot).pack(padx=50,pady=5,anchor=W)  
Button(root,text='Quitter',command=root.quit).pack(padx=46,pady=5,anchor=W)
